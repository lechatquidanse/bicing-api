...
scp -o 'StrictHostKeyChecking no' ./docker/stages/production/.env ${SERVER_PRODUCTION}:/var/www/bicing-api/.env
scp -o 'StrictHostKeyChecking no' ./docker/stages/production/docker-compose.yml ${SERVER_PRODUCTION}:/var/www/bicing-api/docker-compose.yml
scp -o 'StrictHostKeyChecking no' ./docker/nginx/bicing-api.conf ${SERVER_PRODUCTION}:/var/www/bicing-api/bicing-api.conf
